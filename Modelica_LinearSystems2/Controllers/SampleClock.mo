...
block SampleClock
  ...
  parameter Types.BlockType blockType=Modelica_LinearSystems2.Controllers.Types.BlockType.Continuous
    ...
    annotation (
      Evaluate=true,
      choices(__Dymola_radioButtons=true, choice=Modelica_LinearSystems2.Controllers.Types.BlockType.Continuous
        "Continuous",
        choice=Modelica_LinearSystems2.Controllers.Types.BlockType.Discrete
        "Discrete"));
  ...
  parameter Types.Init initType=Modelica_LinearSystems2.Controllers.Types.Init.SteadyState
...
drag Modelica_LinearSystems2.Controllers.SampleClock into the top level of your model.",
    Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}}),
      graphics={
        ...
        Text(
          ...
          visible=blockType==Modelica_LinearSystems2.Controllers.Types.BlockType.Continuous),
        Text(
          extent={{-150,-20},{150,-50}},
          textColor={0,0,0},
          textString="Discrete",
          visible=blockType==Modelica_LinearSystems2.Controllers.Types.BlockType.Discrete),
        Text(
