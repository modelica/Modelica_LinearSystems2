...
model Discretization1 "Demonstrates the discretization methods"
  ...
  Modelica_LinearSystems2.Controllers.SecondOrder continuous(w=w, D=D)
    annotation (Placement(transformation(extent={{-40,40},{-20,60}})));
  inner Modelica_LinearSystems2.Controllers.SampleClock sampleClock(sampleTime=
        0.01)
  ...
  Modelica_LinearSystems2.Controllers.SecondOrder explicitEuler(
    w=w,
    D=D,
    blockType=Modelica_LinearSystems2.Controllers.Types.BlockTypeWithGlobalDefault.Discrete,
    methodType=Modelica_LinearSystems2.Controllers.Types.MethodWithGlobalDefault.ExplicitEuler)
    annotation (Placement(transformation(extent={{-40,0},{-20,20}})));

  Modelica_LinearSystems2.Controllers.SecondOrder implicitEuler(
    w=w,
    D=D,
    blockType=Modelica_LinearSystems2.Controllers.Types.BlockTypeWithGlobalDefault.Discrete,
    methodType=Modelica_LinearSystems2.Controllers.Types.MethodWithGlobalDefault.ImplicitEuler)
    annotation (Placement(transformation(extent={{-40,-40},{-20,-20}})));

  Modelica_LinearSystems2.Controllers.SecondOrder trapezoid(
    w=w,
    D=D,
    blockType=Modelica_LinearSystems2.Controllers.Types.BlockTypeWithGlobalDefault.Discrete,
    methodType=Modelica_LinearSystems2.Controllers.Types.MethodWithGlobalDefault.Trapezoidal)
  ...
  Modelica_LinearSystems2.Controllers.SecondOrder stepExact(
    w=w,
    D=D,
    blockType=Modelica_LinearSystems2.Controllers.Types.BlockTypeWithGlobalDefault.Discrete,
  ...
  Modelica_LinearSystems2.Controllers.SecondOrder rampExact(
    w=w,
    D=D,
    blockType=Modelica_LinearSystems2.Controllers.Types.BlockTypeWithGlobalDefault.Discrete,
    methodType=Modelica_LinearSystems2.Controllers.Types.MethodWithGlobalDefault.RampExact)
