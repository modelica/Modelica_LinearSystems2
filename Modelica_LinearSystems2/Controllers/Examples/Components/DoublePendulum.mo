...
equation
  ...
  connect(relativeVelocity.v_rel[1], v) annotation (Line(
      points={{-86,-30.3333},{-104,-30.3333},{-104,-32},{-118,-32},{-118,62},{42,62},{42,60},{160,60}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(relativePosition.r_rel[1], s) annotation (Line(
      points={{-86,-60.3333},{-104,-60.3333},{-104,-58},{-120,-58},{-120,100},{160,100}},
      color={0,0,127},
      smooth=Smooth.None));
  ...
  connect(add.u1, relativeAngles.angles[3]) annotation (Line(
      points={{114,6},{108,6},{108,-4},{58,-4},{58,-36},{-20,-36},{-20,-31.6667}},
      color={0,0,127},
      smooth=Smooth.None));
