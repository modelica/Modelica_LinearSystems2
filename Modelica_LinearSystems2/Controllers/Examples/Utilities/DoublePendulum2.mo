...
<p>The physical Model is used in Modelica_LinearSystems2.Examples.StateSpace.doublePendulumController where it is being linearized an used as a base for linear controller design. The results are used to control the crane system as shown in <a href=\"modelica://Modelica_LinearSystems2.Controllers.Examples.DoublePendulum\">double pendulum example</a>.</p>
</html>"),
