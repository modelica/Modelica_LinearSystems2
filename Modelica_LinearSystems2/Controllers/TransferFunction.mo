...
initial equation
  if continuous and nx>0 then
    if init ==Modelica_LinearSystems2.Controllers.Types.Init.SteadyState then
      der(x_scaled) = zeros(nx);
    elseif init ==Modelica_LinearSystems2.Controllers.Types.Init.InitialState then
      x_scaled = x_start*a_end;
    elseif init ==Modelica_LinearSystems2.Controllers.Types.Init.InitialOutput then
      y = y_start;
