...
algorithm
  Modelica_LinearSystems2.Utilities.Plot.rootLocusOfModel("Modelica.Blocks.Examples.PID_Controller", {Modelica_LinearSystems2.Records.ParameterVariation(
    Name="PI.k",
    Value=100,
    Min=0,
    Max=1e+100),Modelica_LinearSystems2.Records.ParameterVariation(
    Name="PI.Ti",
...
over the time constant <strong>Ti</strong> of the PID controller with a logarithmic gridding in Ti and a fixed
