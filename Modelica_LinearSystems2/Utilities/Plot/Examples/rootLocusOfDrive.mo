...
algorithm
  Modelica_LinearSystems2.Utilities.Plot.rootLocusOfModel("Modelica.Mechanics.Rotational.Examples.First", modelParam={Modelica_LinearSystems2.Records.ParameterVariation(
    Name="Jload",
    grid=Modelica_LinearSystems2.Utilities.Types.Grid.Equidistant,
    nPoints=30,
    Min=1,
    Max=20),Modelica_LinearSystems2.Records.ParameterVariation(Name="Jmotor", Value=0.1)});
