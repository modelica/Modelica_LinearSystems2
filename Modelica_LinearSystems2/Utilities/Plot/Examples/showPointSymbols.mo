...
algorithm
  Modelica_LinearSystems2.Utilities.Plot.diagram(
    ...
    legend="Cross"),Modelica_LinearSystems2.Utilities.Plot.Records.Curve(
    x=x2,
    y=y1,
    autoLine=false,
    lineColor={0,128,255},
    ...
    legend="Circle"),Modelica_LinearSystems2.Utilities.Plot.Records.Curve(
    x=x3,
    y=y1,
    autoLine=false,
    lineColor={0,0,0},
    ...
    legend="Square"),Modelica_LinearSystems2.Utilities.Plot.Records.Curve(
    x=x4,
    y=y1,
    autoLine=false,
    lineColor={255,0,0},
    ...
    legend="TriangleUp"),Modelica_LinearSystems2.Utilities.Plot.Records.Curve(
    x=x7,
    y=y1,
    autoLine=false,
    ...
    legend="Diamond"),Modelica_LinearSystems2.Utilities.Plot.Records.Curve(
    x=x8,
    y=y1,
    autoLine=false,
    ...
    legend="Dot")}, heading="PointSymbols / lineSymbols"));
