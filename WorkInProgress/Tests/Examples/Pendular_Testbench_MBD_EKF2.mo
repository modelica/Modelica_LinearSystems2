...
model Pendular_Testbench_MBD_EKF2
  ...
  Modelica.Blocks.Sources.Sine sine(                freqHz=0.1, amplitude=1000,
...
equation
  ...
  connect(multiplex2_1.y, extendedKalman.y) annotation (Line(
      points={{41,-40},{48,-40},{48,6},{58,6}},
      color={0,0,127},
      smooth=Smooth.None));
  annotation (Diagram(graphics),
    experiment(StopTime=50),
    experimentSetupOutput,
    Commands(file="WorkInProgress/Tests/Examples/plotResultsEKF2.mos"
        "plotResults"));
end Pendular_Testbench_MBD_EKF2;
