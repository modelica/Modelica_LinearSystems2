...
model Example_EKF
  ...
  Modelica_LinearSystems2.Controller.EKF eKF(
    ...
    redeclare function ekfFunction =
        Modelica_LinearSystems2.WorkInProgress.Tests.Examples.ekf_LinearSystem,
    sampleFactor=10,
...
equation
  ...
  connect(multiplex3_1.u3[1], systemModel.y[3]) annotation (Line(
      ...
      color={0,0,127},
      smooth=Smooth.None));
  connect(eKF.y_measure, multiplex3_1.y) annotation (Line(
      points={{58,-15},{41,-15},{41,-30}},
      color={0,0,127},
      smooth=Smooth.None));
  connect(eKF.u[1], sine.y) annotation (Line(
      points={{58,-5},{30,-5},{30,20},{-68,20},{-68,10},{-79,10}},
      color={0,0,127},
      smooth=Smooth.None));
