...
algorithm
  Modelica_LinearSystems2.Utilities.Plot.diagram(
    ...
    legend="Solid"),Modelica_LinearSystems2.Utilities.Plot.Records.Curve(
    x=x2,
    y=y1,
    autoLine=false,
    lineColor={0,128,255},
    ...
    legend="Dash"),Modelica_LinearSystems2.Utilities.Plot.Records.Curve(
    x=x3,
    y=y1,
    autoLine=false,
    lineColor={0,0,0},
    ...
    legend="Dot"),Modelica_LinearSystems2.Utilities.Plot.Records.Curve(
    x=x4,
    y=y1,
    autoLine=false,
    lineColor={255,0,0},
    ...
    legend="DashDot"),Modelica_LinearSystems2.Utilities.Plot.Records.Curve(
    x=x5,
    y=y1,
    autoLine=false,
    lineColor={0,0,255},
    ...
    legend="DashDotDot")}, heading="Line patterns"));
