...
function linearize2
  "Linearize a model after simulation up to a given time and return it as StateSpace object"
...
protected
  ...
  Boolean OK1 = if linearizeAtInitial then true else
  ...
  Boolean OK2 = if linearizeAtInitial then true else importInitial("dsfinal.txt");
