within ;
package Modelica_LinearSystems2 "Modelica_LinearSystems2 (version 2.3.3) - Analysis, Synthesis and Modeling of Continuous and Discrete Linear Systems"
...
annotation (
  ...
  dateModified = "2015-09-08 15:20:01Z",
  revisionId="$Id::                                       $",
  conversion(
    noneFromVersion="2.0",
    noneFromVersion="2.1",
